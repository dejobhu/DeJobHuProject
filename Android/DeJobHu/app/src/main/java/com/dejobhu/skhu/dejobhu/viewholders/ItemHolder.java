 ...
 */
package com.dejobhu.skhu.dejobhu.viewholders;
...
import static com.dejobhu.skhu.dejobhu.utils.BaseUtils.TYPE_LIST;
...
public class ItemHolder extends RecyclerView.ViewHolder {
    ...
    private static int getLayoutResourceId(int type) {
        ...
        switch (type) {
            case TYPE_LIST:
                selectedLayoutResource = R.layout.list_expand_layout_news_card;
                break;
